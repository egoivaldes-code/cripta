...
import { TILE, moveDurationMs } from './config.js?v=0.33.2';
...
export const IDLE_NAME = { enemy1: 'idle', enemy4: 'idle', enemy5: 'idle', enemy6: 'idle', golembone: 'idle', hero: 'idlepeace', chest: 'idle', container: 'idle', altar: 'idle', lever: 'idle' };
