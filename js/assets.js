...
import { VERSION } from './config.js?v=0.33.1';
...
const sources = {
  ...
  lever: {
    idle: './assets/props/lever/idle.png',
    open: './assets/props/lever/open.png',
  },
  container: {
  ...
  altar: {
    idle:      './assets/props/altar/idle.png',
    activate1: './assets/props/altar/activate1.png',
    activate2: './assets/props/altar/activate2.png',
    activate3: './assets/props/altar/activate3.png',
    activate4: './assets/props/altar/activate4.png',
    activate5: './assets/props/altar/activate5.png',
    activate6: './assets/props/altar/activate6.png',
    activate7: './assets/props/altar/activate7.png',
    activate8: './assets/props/altar/activate8.png',
    activate9: './assets/props/altar/activate9.png',
    activate10: './assets/props/altar/activate10.png',
  },
  // Tarjetas de ambientación del altar: pregunta inicial + una por cada uno
  // de los 10 eventos del pool (ver ALTAR_EVENTS en rules.js).
  altar_decision: './assets/ui/altars/altar_decision.jpg',
  altar_ev1:  './assets/ui/altars/altar_ev1.jpg',
  altar_ev2:  './assets/ui/altars/altar_ev2.jpg',
  altar_ev3:  './assets/ui/altars/altar_ev3.jpg',
  altar_ev4:  './assets/ui/altars/altar_ev4.jpg',
  altar_ev5:  './assets/ui/altars/altar_ev5.jpg',
  altar_ev6:  './assets/ui/altars/altar_ev6.jpg',
  altar_ev7:  './assets/ui/altars/altar_ev7.jpg',
